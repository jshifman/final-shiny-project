...
intro <- tabPanel(
  ...
  fluidPage(
    ...
    year and over the years the game of basketball has changed in my ways. The 
    names of teams have changed, the unfiforms have changed, and even the way
    ...
    which wasn't had to the game until 1979. Today 3-pt shots are such an icon,
    ...
    they started becoming more becoming more skilled with these shots, and how
    the chance to score 3pts rathen 1 or 2, changed the scoring of the game
